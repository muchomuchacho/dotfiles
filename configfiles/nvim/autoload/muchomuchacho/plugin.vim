...
function! muchomuchacho#plugin#lazy(config) abort
...
function! s:load(id) abort
  ...
  call muchomuchacho#plugin#packadd(l:pack, l:plugin)
...
function! muchomuchacho#plugin#packadd(pack, plugin) abort
  if has('packages')
